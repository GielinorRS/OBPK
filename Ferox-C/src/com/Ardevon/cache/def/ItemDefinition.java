...
import com.Ardevon.cache.def.impl.items.CustomItems;
        ...
        if (def.name != null) {
            ...
            if (!def.name.startsWith("<col=65280>"))
            {
                if ((def.name.toLowerCase().contains("pet")) || (def.name.toLowerCase().contains("3rd")) || (def.name.toLowerCase().contains("toxic")) || (def.name.toLowerCase().contains("occult")) || (def.name.toLowerCase().contains("anguish")) || (def.name.toLowerCase().contains("torture")) || (def.name.toLowerCase().contains("avernic")) || (def.name.toLowerCase().contains("serpentine")) || (def.name.toLowerCase().contains("tanzanite")) || (def.name.toLowerCase().contains("magma")) || (def.name.toLowerCase().contains("ancestral")) || (def.name.toLowerCase().contains("armadyl")) || (def.name.toLowerCase().contains("void"))
                    ...
                    || (def.name.toLowerCase().contains("twisted buckler")) || (def.name.toLowerCase().contains("dragon dart")) || (def.name.toLowerCase().contains("guthix rest")) || (def.name.toLowerCase().contains("obsidian")) || (def.name.toLowerCase().contains("regen bracelet")) || (def.name.toLowerCase().contains("rangers'")) || (def.name.toLowerCase().contains("dragon scimitar (or)")) || (def.name.toLowerCase().contains("Ardevon coins")) || (def.name.toLowerCase().contains("divine")) || (def.name.toLowerCase().contains("super antifire")) || (def.name.toLowerCase().contains("robin hood hat")) || (def.name.toLowerCase().contains("ankou"))
                    || (def.name.toLowerCase().contains("santa")) || (def.name.toLowerCase().contains("halloween")) || (def.name.toLowerCase().contains("present")) || (def.name.toLowerCase().contains("sack of presents")) || (def.name.toLowerCase().contains("dye"))) {
                    def.name = ("<col=65280>" + def.name);
                }
