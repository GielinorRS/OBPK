...
import com.Ardevon.cache.def.impl.npcs.CustomBosses;
import com.Ardevon.cache.def.impl.npcs.CustomPets;
import com.Ardevon.cache.def.impl.NpcManager;
import com.Ardevon.cache.def.impl.npcs.MemberNpcs;
...
public final class NpcDefinition {
    ...
    public Model get_animated_model(int animation, int current, int[] label) {
        ...
        if (occupied_tiles == 1) {
            animated_model.fits_on_single_square = true;
        }
