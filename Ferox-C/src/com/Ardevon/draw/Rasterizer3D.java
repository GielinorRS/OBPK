package com.Ardevon.draw;

import com.Ardevon.ClientConstants;
import com.Ardevon.cache.Archive;
import com.Ardevon.cache.graphics.IndexedImage;
...
public final class Rasterizer3D extends Rasterizer2D {
    ...
    public static void drawTexturedTriangle(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11, int var12, int var13, int var14, int var15, int var16, int var17, int var18) {
        int[] texturePixels = get_texels(var18)[scale];
        int var21;
        opaque = !transparent[var18];
        var21 = var4 - var3;
        int var26 = var1 - var0;
        int var27 = var5 - var3;
        int var31 = var2 - var0;
    ...
    static void drawTexturedLine(int[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11, int var12, int var13, int var14) {
        if(testX) {
            if(var6 > Rasterizer2D.center_x) {
                var6 = Rasterizer2D.center_x;
            }
    ...
    public static void drawTexturedTriangle2(int y1, int y2, int y3, int x1, int x2, int x3, int c1, int c2, int c3, int tx1, int tx2, int tx3, int ty1, int ty2, int ty3, int tz1, int tz2, int tz3, int tex, float z1, float z2, float z3, int bufferOffset) {
    ...
    public static void drawTexturedTriangle3(int y1, int y2, int y3, int x1, int x2, int x3, int c1, int c2, int c3, int tx1, int tx2, int tx3, int ty1, int ty2, int ty3, int tz1, int tz2, int tz3, int tex) {
        c1 = 0x7f - c1 << 1;
        c2 = 0x7f - c2 << 1;
        c3 = 0x7f - c3 << 1;
