...
public final class SignLink implements Runnable {
    ...
    public static String findCacheDir() {
        final File cacheDirectory = new File(ClientConstants.CACHE_DIRECTORY);
        if (!cacheDirectory.exists())
            cacheDirectory.mkdir();
        return ClientConstants.CACHE_DIRECTORY;
    }

    public static String findDataDir() {
        final File cacheDirectory = new File(ClientConstants.DATA_DIRECTORY);
        if (!cacheDirectory.exists())
            cacheDirectory.mkdir();
        return ClientConstants.DATA_DIRECTORY;
    }
