...
public class CombatFormula {
    ...
    public static boolean wearingDarkbandos(Player p) {
        return (p.getEquipment().contains(26502) && p.getEquipment().contains(26504) && p.getEquipment().contains(26503) && p.getEquipment().hasAt(EquipSlot.LEGS,26504) && p.getEquipment().hasAt(EquipSlot.BODY,26503)&& p.getEquipment().hasAt(EquipSlot.HEAD,26502));
    }

    public static boolean wearingDarkarmadyl(Player p) {
        return (p.getEquipment().contains(26500) && p.getEquipment().contains(26501) && p.getEquipment().hasAt(EquipSlot.LEGS,26501) && p.getEquipment().hasAt(EquipSlot.BODY,26502));
    }
    ...
    public static int modifyMagicDamage(Player player, int spell_maxhit, String spell_name, boolean includeNpcMax) {
        ...
        if (wearingDarkbandos(player)) {
            multi += 0.025;
        }
        if (wearingDarkarmadyl(player)) {
            multi += 0.025;
        }
