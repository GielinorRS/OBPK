...
public class DwarfCannon extends OwnedObject {
    ...
    public static final Area[] AREA_RESTRICTIONS = {
        ...
        //new Area(1247, 10144, 1411, 10296, -1), //Karluum dungeon this area for cannon fixed player able now to setup cannon karluum ty
    ...
    private void rotate() {
        ...
        target.ifPresent(npc -> {
            ...
            //1stupdatecannon by the plateau
            int damage = Utils.random(MAX_HIT);
            getOwner().skills().addXp(4,damage * 2);
