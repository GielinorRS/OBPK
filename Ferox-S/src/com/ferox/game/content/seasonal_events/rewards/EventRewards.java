...
public enum EventRewards {
    ...
    EVENT_REWARD_29(new Item(CustomItemIdentifiers.LARRANS_KEY_TIER_I), 70, EVENT_REWARD_29_CLAIMED),
    EVENT_REWARD_30(new Item(CustomItemIdentifiers.LARRANS_KEY_TIER_I), 65, EVENT_REWARD_30_CLAIMED),
    EVENT_REWARD_31(new Item(CustomItemIdentifiers.LARRANS_KEY_TIER_I), 60, EVENT_REWARD_31_CLAIMED),
    EVENT_REWARD_32(new Item(CustomItemIdentifiers.ZENYTE_MYSTERY_BOX), 55, EVENT_REWARD_32_CLAIMED),
    ...
    EVENT_REWARD_41(new Item(CustomItemIdentifiers.KEY_OF_BOXES), 10, EVENT_REWARD_41_CLAIMED),
    ...
    EVENT_REWARD_44(new Item(CustomItemIdentifiers.WINTER_ITEM_CASKET), 0, EVENT_REWARD_44_CLAIMED)//Contains a random cosmetic
    ;
