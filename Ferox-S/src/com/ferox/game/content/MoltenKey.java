...
public class MoltenKey extends PacketInteraction {
    ...
    private enum PvpRewards {
        ...
        TWELFTH(2, new Item[]{new Item(CustomItemIdentifiers.LAVA_PARTYHAT)}),
        THIRTEENTH(2, new Item[]{new Item(CustomItemIdentifiers.MOLTEN_PARTYHAT)}),
        FOURTEENTH(2, new Item[]{new Item(CustomItemIdentifiers.MOLTEN_MYSTERY_BOX)});
    ...
    private static void reward(Player player) {
        ...
        if(drop != null) {
            ...
            World.getWorld().sendWorldMessage("<img=1081>" + player.getUsername() + " received: <col=A30072>" + drop.name() + " </col>from the molten key.");
        }
