...
import com.ferox.game.world.entity.combat.method.impl.specials.melee.DragonClaws;
...
public enum Collection {
    ...
    KRAKEN(AttributeKey.KRAKENS_KILLED, LogType.BOSSES, "Kraken", new int[]{NpcIdentifiers.KRAKEN}, AttributeKey.KRAKEN_LOG_CLAIMED, new Item[]{new Item(ANCIENT_WYVERN_SHIELD), new Item(DRAGONFIRE_WARD)},
        ...
        new Item(ABYSSAL_TENTACLE), new Item(TRIDENT_OF_THE_SEAS), new Item(JAR_OF_DIRT), new Item(ANCIENT_WYVERN_SHIELD), new Item(DRAGONFIRE_WARD), new Item(NIGHTMARE_STAFF)),
    ...
    VORKATH(AttributeKey.VORKATHS_KILLED, LogType.BOSSES, "Vorkath", new int[]{NpcIdentifiers.VORKATH}, AttributeKey.VORKATH_LOG_CLAIMED, new Item[]{new Item(VORKATHS_HEAD_21907), new Item(DRAGON_HUNTER_CROSSBOW)},
        //Drops
    ...
    ZULRAH(AttributeKey.ZULRAHS_KILLED, LogType.BOSSES, "Zulrah", new int[]{NpcIdentifiers.ZULRAH, NpcIdentifiers.ZULRAH_2044, NpcIdentifiers.ZULRAH_2043}, AttributeKey.ZULRAH_LOG_CLAIMED, new Item[]{new Item(KEY_OF_BOXES)}, //, new Item(TRIDENT_OF_THE_SWAMP), new Item(TOXIC_STAFF_OF_THE_DEAD)
        //Drops
    ...
    GIANT_MOLE(AttributeKey.KC_GIANTMOLE, LogType.BOSSES, "Giant Mole", new int[]{NpcIdentifiers.GIANT_MOLE}, AttributeKey.GIANT_MOLE_LOG_CLAIMED, new Item[]{new Item(DRAGON_CLAWS)},
        //Drops
         new Item(NIFFLER),
        new Item(MOLE_SKIN), new Item(MOLE_CLAW), new Item(DRAGON_CLAWS), new Item(KEY_OF_BOXES)),

    CORRUPTED_NECHRYARCH(AttributeKey.CORRUPTED_NECHRYARCHS_KILLED, LogType.BOSSES, "Corrupted Nechryarch", new int[]{CustomNpcIdentifiers.CORRUPTED_NECHRYARCH}, AttributeKey.CORRUPTED_NECHRYARCH_LOG_CLAIMED, new Item[]{new Item(CustomItemIdentifiers.LEGENDARY_MYSTERY_BOX, 3)},
        //Drops
        new Item(CustomItemIdentifiers.PET_CORRUPTED_NECHRYARCH),
        new Item(CORRUPTED_BOOTS), new Item(EPIC_PET_BOX), new Item(CustomItemIdentifiers.LEGENDARY_MYSTERY_BOX), new Item(CustomItemIdentifiers.ZENYTE_MYSTERY_BOX), new Item(ARMADYL_GODSWORD_OR), new Item(DRAGON_CLAWS_OR), new Item(KEY_OF_BOXES)),

    ANCIENT_CHAOS_ELEMENTAL(AttributeKey.ANCIENT_CHAOS_ELEMENTALS_KILLED, LogType.BOSSES, "Ancient Chaos Elemental", new int[]{CustomNpcIdentifiers.ANCIENT_CHAOS_ELEMENTAL}, AttributeKey.ANCIENT_CHAOS_ELEMENTAL_LOG_CLAIMED, new Item[]{new Item(KEY_OF_BOXES)},
        //Drops
    ...
    ANCIENT_KING_BLACK_DRAGON(AttributeKey.ANCIENT_KING_BLACK_DRAGONS_KILLED, LogType.BOSSES, "Ancient King Black Dragon", new int[]{CustomNpcIdentifiers.ANCIENT_KING_BLACK_DRAGON}, AttributeKey.ANCIENT_KING_BLACK_DRAGON_LOG_CLAIMED, new Item[]{new Item(KEY_OF_BOXES)},
        //Drops
    ...
    SKORPIOS(AttributeKey.SKORPIOS_KILLED, LogType.BOSSES, "Skorpios", new int[]{CustomNpcIdentifiers.SKORPIOS}, AttributeKey.SKORPIOS_LOG_CLAIMED, new Item[]{new Item(SAELDOR_SHARD, 100)},
        ...
        new Item(KEY_OF_BOXES), new Item(EPIC_PET_BOX), new Item(LARRANS_KEY_TIER_III), new Item(CustomItemIdentifiers.LEGENDARY_MYSTERY_BOX), new Item(SAELDOR_SHARD), new Item(DARK_ARMADYL_HELMET), new Item(BOW_OF_FAERDHINEN_3)
    ),
    ...
    ARACHNE(AttributeKey.ARACHNE_KILLED, LogType.BOSSES, "Arachne", new int[]{CustomNpcIdentifiers.ARACHNE}, AttributeKey.ARACHNE_LOG_CLAIMED, new Item[]{new Item(SAELDOR_SHARD, 100)},
        ...
        new Item(KEY_OF_BOXES), new Item(EPIC_PET_BOX), new Item(LARRANS_KEY_TIER_III), new Item(CustomItemIdentifiers.LEGENDARY_MYSTERY_BOX), new Item(SAELDOR_SHARD), new Item(DARK_ARMADYL_CHAINSKIRT), new Item(BOW_OF_FAERDHINEN_3)
    ),
    ...
    ARTIO(AttributeKey.ARTIO_KILLED, LogType.BOSSES, "Artio", new int[]{CustomNpcIdentifiers.ARTIO}, AttributeKey.ARTIO_LOG_CLAIMED, new Item[]{new Item(SAELDOR_SHARD, 100)},
        ...
        new Item(KEY_OF_BOXES), new Item(EPIC_PET_BOX), new Item(LARRANS_KEY_TIER_III), new Item(CustomItemIdentifiers.LEGENDARY_MYSTERY_BOX), new Item(SAELDOR_SHARD), new Item(DARK_ARMADYL_CHESTPLATE), new Item(BOW_OF_FAERDHINEN_3)
    ),
    ...
    CORRUPTED_HUNLEFF(AttributeKey.CORRUPTED_HUNLEFFS_KILLED, LogType.BOSSES, "Corrupted Hunleff", new int[]{NpcIdentifiers.CORRUPTED_HUNLLEF, NpcIdentifiers.CORRUPTED_HUNLLEF_9036, NpcIdentifiers.CORRUPTED_HUNLLEF_9037}, AttributeKey.CORRUPTED_HUNLEFF_LOG_CLAIMED, new Item[]{new Item(KEY_OF_BOXES)},
        //Drops
    ...
    MYSTERY_CHEST(AttributeKey.MYSTERY_CHESTS_OPENED, LogType.MYSTERY_BOX, "Mystery chest", new int[]{CustomItemIdentifiers.MYSTERY_CHEST}, AttributeKey.MYSTERY_CHEST_LOG_CLAIMED, new Item[]{new Item(CustomItemIdentifiers.MYSTERY_CHEST, 2)},
        new Item(SANGUINE_TWISTED_BOW), new Item(SANGUINE_SCYTHE_OF_VITUR), new Item(ELYSIAN_SPIRIT_SHIELD), new Item(SHADOW_GREAT_HELM), new Item(SHADOW_HAUBERK), new Item(SHADOW_PLATESKIRT),
        ...
        new Item(BOW_OF_FAERDHINEN_3), new Item(ELDER_WAND_HANDLE), new Item(ELDER_WAND_STICK), new Item(SWORD_OF_GRYFFINDOR), new Item(TALONHAWK_CROSSBOW), new Item(BLADE_OF_SAELDOR_8),
    ...
    CHAMBER_OF_XERIC(AttributeKey.CHAMBER_OF_XERIC_RUNS_CHALLENGE_COMPLETED, LogType.OTHER, "Chamber of Xeric", new int[]{RAIDS_KEY}, AttributeKey.CHAMBER_OF_XERIC_LOG_CLAIMED,
        ...
        //Drops
        new Item(SCYTHE_OF_VITUR), new Item(TWISTED_BOW), new Item(ANCESTRAL_ROBE_BOTTOM), new Item(ANCESTRAL_ROBE_TOP), new Item(ANCESTRAL_HAT), new Item(ELDER_MAUL),
        new Item(DEXTEROUS_PRAYER_SCROLL), new Item(KODAI_WAND), new Item(CustomItemIdentifiers.LEGENDARY_MYSTERY_BOX), new Item(DINHS_BULWARK), new Item(DRAGON_HUNTER_CROSSBOW), new Item(TWISTED_BUCKLER), new Item(ARCANE_PRAYER_SCROLL), new Item(DRAGON_CLAWS),new Item(SCYTHE_OF_VITUR_KIT),new Item(TWISTED_BOW_KIT)
