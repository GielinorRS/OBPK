...
import com.ferox.autobackup.PlateauBackup;
...
public class GameServer {
    ...
    /**
     * Auto backup for players to desktop
     */
    public static PlateauBackup backups = new PlateauBackup();
    /**
     * Filestore instance
     */
    ...
    public static void main(String[] args) {
        try {
            ...
            bootstrap.bind();
            backups.start();//thank you bro! so when i do his update it wont effect this right?
            //if you choose his changes only on commint
            initializeDatabase();
