...
public class PlateauBackup {
    ...
    private final long backup_period = TimeUnit.HOURS.toMillis(1);//this is time it will start backup

    public void start() {//you here bro? yes sorry was paying you np i made it 1 minute to backup to show u okay!
