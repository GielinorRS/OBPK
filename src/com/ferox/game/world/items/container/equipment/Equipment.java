...
public final class Equipment extends ItemContainer {
    ...
    private final List<Integer> MAX_CAPES = Arrays.asList(
        ...
        INFERNAL_MAX_CAPE_21285, IMBUED_GUTHIX_MAX_CAPE, IMBUED_SARADOMIN_MAX_CAPE, IMBUED_ZAMORAK_MAX_CAPE, ASSEMBLER_MAX_CAPE, MYTHICAL_MAX_CAPE, FROST_IMBUED_MAX_CAPE);

    private final List<Integer> MAX_HOODES = Arrays.asList(MAX_HOOD, FIRE_MAX_HOOD, SARADOMIN_MAX_HOOD, ZAMORAK_MAX_HOOD, GUTHIX_MAX_HOOD, ACCUMULATOR_MAX_HOOD, ARDOUGNE_MAX_HOOD, INFERNAL_MAX_HOOD, IMBUED_SARADOMIN_MAX_HOOD, IMBUED_ZAMORAK_MAX_HOOD, IMBUED_GUTHIX_MAX_HOOD, ASSEMBLER_MAX_HOOD, MYTHICAL_MAX_HOOD, FROST_IMBUED_MAX_HOOD);
    ...
    private final int[] SLAYER_HELMETS = new int[] {RED_SLAYER_HELMET_I,
        BLACK_SLAYER_HELMET_I,GREEN_SLAYER_HELMET_I, TURQUOISE_SLAYER_HELMET_I,HYDRA_SLAYER_HELMET_I,SLAYER_HELMET, SLAYER_HELMET_I, RED_SLAYER_HELMET, GREEN_SLAYER_HELMET, BLACK_SLAYER_HELMET, PURPLE_SLAYER_HELMET, PURPLE_SLAYER_HELMET_I, TURQUOISE_SLAYER_HELMET};
