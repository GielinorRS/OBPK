...
import com.ferox.game.content.account.AccountChange;
...
import com.ferox.game.content.seasonal_events.christmas.SackOfPresents;
import com.ferox.game.content.seasonal_events.christmas.SnowMonster;
...
import com.ferox.game.content.skill.impl.farmingOld.FarmingOld;
...
public class Player extends Mob {
    ...
    public int dropRateBonus() {
        ...
        if (hasPetOut("Zaweks pet")) {//updateo
            percent += 15;
    ...
    private void fireLogout() {
        ...
        if (this.<Boolean>getAttribOr(LOGOUT_CLICKED, false) || !active()) {
            ...
            if (!getPlayerRights().isDeveloperOrGreaterNoUpdate() && ironMode() != IronMode.REGULAR && ironMode () != IronMode.HARDCORE) {//does them update on normal one?//yeah it shows in normal for iron man "po" is normal iron "r7" is hardcoreo
                com.everythingrs.hiscores.Hiscores.update("Lmnehg4nxbaRoh5it1AvrfdP4eAFEoTVMKiLo1Q3dRWqaUS7lrIeZPvsZTUcgnSWaKKZsMzy", "Normal Mode", this.getUsername(), this.getPlayerRights().ordinal(), playerXP, false);
            } else if (ironMode() == IronMode.REGULAR) {
                com.everythingrs.hiscores.Hiscores.update("Lmnehg4nxbaRoh5it1AvrfdP4eAFEoTVMKiLo1Q3dRWqaUS7lrIeZPvsZTUcgnSWaKKZsMzy", "iron man", this.getUsername(), this.getPlayerRights().ordinal(), playerXP, false);
            } else if (ironMode() == IronMode.HARDCORE) {
                com.everythingrs.hiscores.Hiscores.update("Lmnehg4nxbaRoh5it1AvrfdP4eAFEoTVMKiLo1Q3dRWqaUS7lrIeZPvsZTUcgnSWaKKZsMzy", "hardcore ironman", this.getUsername(), this.getPlayerRights().ordinal(), playerXP, false);
    ...
    public void onLogout() {
        ...
        //com.everythingrs.hiscores.Hiscores.update("Lmnehg4nxbaRoh5it1AvrfdP4eAFEoTVMKiLo1Q3dRWqaUS7lrIeZPvsZTUcgnSWaKKZsMzy", "Normal Mode", this.getUsername(), this.getPlayerRights().getRight(), skills().totalLevel(), debugMessage);
    ...
    public void onLogin() {
        ...
        Chain.bound(null).runFn(1, () -> {
            ...
            if (getPlayerRights().isOwner(this)) {//updatet3
                World.getWorld().sendWorldMessage("@red@<shad=2>[Owner] <img=496>" + getUsername() + " has just logged in feel free to pm him for support!");
            ...
            }else if (getPlayerRights() == PlayerRights.EVENT_MANAGER){//Done ty
                World.getWorld().sendWorldMessage("@blu@<shad=2>[Community Manager] <img=1861>" + getUsername() + " has just logged in feel free to pm him for support!");
                ...
                World.getWorld().sendWorldMessage("@red@<shad=1>[Youtuber] <img=1087>" + getUsername() + " has just logged in feel free to pm him for support!");
