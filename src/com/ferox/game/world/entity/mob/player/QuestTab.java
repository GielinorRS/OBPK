...
public final class QuestTab {
    ...
    public static boolean onButton(Player player, int button) {
        switch (button) {
            case 12661 -> {
                player.getPacketSender().sendURL("http://revolution-ps.net/");
                player.message("Opening http://revolution-ps.net/ in your web browser...");
            }

            case 12662 -> {
                player.getPacketSender().sendURL("http://discord.com/invite/Qx7AmUTHPX");
                player.message("Opening discord in your web browser...");
                return true;
            }

            case 12663 -> {
                player.getPacketSender().sendURL("http://revolution-ps.net/store/");
                player.message("Opening http://revolution-ps.net/store/ in your web browser...");
                return true;
            }
