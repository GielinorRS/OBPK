...
import com.ferox.game.content.seasonal_events.christmas.WinterEvent;
...
public class World {
    ...
    public int xpMultiplier = applyDoubleExperience() ? 1 : 1;
    public int slayerRewardPointsMultiplier = applyDoubleSlayerRewardPoints() ? 1 : 1;
