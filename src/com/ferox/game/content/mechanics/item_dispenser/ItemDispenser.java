...
public class ItemDispenser {
    ...
    private void dispense() {
        if(!player.inventory().hasCapacityFor(new Item(CustomItemIdentifiers.REVOLUTION_COINS))) {
        ...
        //Add coins to inv
        player.inventory().add(new Item(CustomItemIdentifiers.REVOLUTION_COINS, totalCartValue),true);
