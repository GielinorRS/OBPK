...
import static com.ferox.util.CustomItemIdentifiers.KEY_OF_BOXES;
...
public class MysteryBoxManager {
    ...
    public void reward() {
        ...
        }else if (reward.getId() == CustomItemIdentifiers.DONATOR_MYSTERY_BOX){
            player.message(Color.ORANGE_2.tag() + "Congratulations, you have received X3 " + reward.unnote().name() + "!");
        }else if (reward.getId() == CustomItemIdentifiers.WEAPON_MYSTERY_BOX){
            player.message(Color.ORANGE_2.tag() + "Congratulations, you have received X3 " + reward.unnote().name() + "!");
        }else if (reward.getId() == CustomItemIdentifiers.ARMOUR_MYSTERY_BOX){
            player.message(Color.ORANGE_2.tag() + "Congratulations, you have received X3 " + reward.unnote().name() + "!");
