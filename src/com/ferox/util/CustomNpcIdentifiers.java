...
public class CustomNpcIdentifiers {
    ...
    public static final int SERENIC = 11115;
    ...
    public static final int ZAWEKS_PET = 4928;//UPDATEO
    public static final int MENDING_LIFE_BIRD = 4929;//UPDATEM
    ...
    public static final int GRIM = 15021;
